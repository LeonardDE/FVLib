...
\begin{center}
  \begin{tikzpicture}[>=latex]
    ...
    \coordinate [label=right:$t_{24}$] (t24) at (6,2);
		...
		\coordinate [label=above:$t_{2}$] (t2) at (1,0);
		\coordinate [label=above:$t_{3}$] (t3) at (2,0);
		\coordinate [label=above:$t_{4}$] (t4) at (3,0);
		\coordinate [label=above:$t_{5}$] (t5) at (4,0);
		\coordinate [label=above:$t_{6}$] (t6) at (5,0);
